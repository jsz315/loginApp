	...
	<view class="box">
		<view class="pop-box">
			...
			<view class="word">
				...
				<view v-if="cur==0">
					<view class="tip1">愿望钱包个人信用借款合同</view>
					<view class="tip1">甲方：借款人</view> 
					<view class="tip1">乙方：愿望钱包</view>
					<view class="tip1">  根据《中华人民共和国合同法》的规定，甲方、乙方本着自愿、平等、互惠互利、诚实信用的原则，经双方一致同意订立本合同书。</view>
					<view class="tip1">  为保障各方当事人的权益，经协商特订一下条款共同遵守，以遵守执行。</view>
					<view class="tip1"></view>
					<view class="tip1">第一条 基本:</view>
					<view class="tip1">甲方如实告知自身信用、经济、有价资产、贷款用途等信息,按照乙方的要求提供真实有效的相关资料。并配合办理相关手续。否则,即使签署了本协议,乙方扔有权拒绝受理并向甲方追偿“违约赔偿金”,并依法追究甲方缔约过失责任。</view>
					<view class="tip1"></view>
					<view class="tip1">第二条 贷款种类：信用贷款</view>
					<view class="tip1"></view>
					<view class="tip1">第三条 借款利率：借款利率为月息0.9%，按月收息，利随本清。</view>
					<view class="tip1"></view>
					<view class="tip1">第四条 还款资金来源及还款方式：</view>
					<view class="tip1">1.还款资金来源：银行代扣</view>
					<view class="tip1">2.还款方式：等额本息</view>
					<view class="tip1"></view>
					<view class="tip1">第五条 保证条款：</view>
					<view class="tip1">
					协议效力的独立性本协议书的效力独立与乙方所签订的借(贷)款合同等合同。前述合同全部或部分无效并不影响本协议的效力、即前述合同及或其项下任一相关附属合同或文件被法院或仲裁机构认定无效的情况下,本协议书仍然有效。
					甲方请大地时代保险有限公司作为借款担保方，经乙方审查，证实担保方具有担保资格和足够代偿借款的能力，乙方有权检查和督促担保方履行合同。当担保方不履行合同时，由担保方连带承担偿还借款本息的责任。必要时，乙方可以从担保方的存款帐户内扣收贷款本息。
					</view>
					<view class="tip1"></view>
					<view class="tip1">第六条 违约责任：</view>
					<view class="tip1">
					1.签订本合同后，乙方应在甲方提出借据1日内(假日顺延)将贷款放出，转入甲方帐户或由甲方(银行)开出汇票发放给乙方。如乙方未按期发放贷款(汇票)，应按违约数额和延期天数的贷款利息的20%向甲方偿付违约金。如甲方未经乙方同意擅自终止此协议时，应偿付违约数额的20%违约金。
					...
					<view class="tip1"></view>
					<view class="tip1">第七条  声明：</view>
					<view class="tip1">本协议书各方已阅读本协议书中的所有条款，对本协议书条款的含义及相应的法律后果已全部通晓并充分理解，同意本协议书时同意各方的真实意思表现，不存在任何欺诈和胁迫的因素。</view>
					<view class="tip1"></view>
					<view class="tip1">第八条  争议解决：</view>
					<view class="tip1">本协议书适用于中华人名共和国法律。本协议履行过程中出现的争议及未尽事宜有协议各方协商解决，协商不成时任何一方可向人民法院诉讼解决。</view>
					<view class="tip1"></view>
					<view class="tip1">第九条  生效：</view>
					<view class="tip1">本协议书自同意后立即生效，具有同等法律效应。</view>
				</view>
				
				<view v-if="cur==1">
					<view>愿望钱包代扣服务协议</view>
					
					<view>愿望钱包在此郑重提示：</view>
					本协议是您(用户，包括自然人、法人) 与湖南盛冉信用服务有限公司之间就“愿望钱包”注册及服务相关事宜所订立的法律协议，第三方代扣协议。   适用于您在愿望钱包注册及使用愿望钱包服务的全部行为。
					...
					<view>第二条：用户注册信息</view>
					用户首次通过愿望钱包 APP 登录，即成为愿望钱包注册用户。
					...
					<view>第三条：愿望钱包服务</view>
					愿望钱包是一个金融信息服务平台，平台不涉及任何现金贷款业务，也不保证会员贷款一定成功。愿望钱包通过愿望钱包 APP（安卓版和 iOS 版）、微信公众号（微信号：）依靠互联网法向愿望钱包注册用户提供互联网信息服务等服务内容。
					...
					用户应当妥善保管本人愿望钱包绑定的手机号码、手机验证码等信息。对于非因愿望钱包过错产生的上述信息泄露所导致的用户损失愿望钱包不承担任何责任；
					...
					<view>第五条：征信授权</view>
					用户在此不可撤销地授权愿望钱包通过依法设立的征信机构了解、咨询、审查用户的个人信息、信用状况、履约能力及其他评定用户资信状况的信息，包含可能存在的用户不良信   用信息。
					用户在此不可撤销地授权代向依法设立的征信机构提供用户接受愿望钱包服务所对应  的个人信息、借贷信息及后续还款记录等信息。
					用户在此不可撤销地授权愿望钱包向依法设立的征信机构提供用户可能产生的不良信  用信息。
					
					<view>第六条：关于第三方代扣协议</view>
					在此特别授权并不可撤销地同意，通过其委托的第三方支付 机构/ 银行从委托人的专用银行账户中，将当期大数据查询付账款以及其他 应付款项直接扣除。
					...
					<view>第七条：信息管理</view>
					除非另有明确的书面说明，愿望钱包及其所包含的或以其它方式通过愿望钱包提供给用户的   全部信息、内容、材料、产品(包括软件) 和服务，均是在“按现状”和“按现有”的基础上提供的。
					如因不可抗力或其它愿望钱包无法控制的原因愿望钱包系统崩溃或无法正常使用导致无法   向用户提供愿望钱包服务的，愿望钱包不承担任何责任。
					
					<view>第八条：用户信息更新</view>
					
					用户接受愿望钱包服务期间，用户本人姓名、身份证号码、手机号码、银行账户、支付宝、   微信等信息如发生变更，应当在相关信息发生变更之日起三日内将更新后的信息提供给愿望钱包。因用户未能及时提供上述变更信息而带来的损失或额外费用应由用户自行承担。
					
					<view>第九条：适用法律及争议解决</view>
					本协议的签订、履行、终止、解释均适用中华人民共和国法律。
					因履行本协议所产生的争议应当通过友好协商解决，如协商不成，则本协议任意一方均  可向本协议签订地天津市武清区有管辖权的人民法院起诉。
					
					
					<view>第十条：其他</view>
					本协议自用户签署并注册成为愿望钱包用户之日起生效，除非愿望钱包终止本协议或者用户丧失愿望钱包用户资格，否则本协议始终有效。出于运行和交易安全的需要，芝麻分   期可以暂时停止提供或者限制本服务部分功能，或提供新的功能，在任何功能减少、增加或   变化时，只要用户仍使用愿望钱包服务，表示用户仍然同意本协议或者变更后的协议。
			...
			<view class="pop-btn" @tap="onClose">关闭</view>
		</view>
	</view>
</template>
