...
Z([3,'tip data-v-34eca017'])
Z([3,'以下为必填资料 填写完善才能申请借款'])
Z([3,'jrow-box data-v-34eca017'])
Z([3,'jrow-tip data-v-34eca017'])
Z([3,'姓名'])
Z([3,'__e'])
Z([3,'jrow-input data-v-34eca017'])
Z([[4],[[5],[[4],[[5],[[5],[1,'input']],[[4],[[5],[[4],[[5],[[5],[1,'__set_model']],[[4],[[5],[[5],[[5],[[5],[1,'']],[1,'account']],[1,'$event']],[[4],[[5]]]]]]]]]]]]])
Z([3,'6-16位字符，包含字母和数字 '])
Z([3,'text'])
Z([[7],[3,'account']])
...
__wxAppCode__['components/j-alert/j-alert.wxss']=setCssToHead([".",[1],"btn.",[1],"data-v-4618ba91 { color: #682FE9; height: ",[0,100],"; line-height: ",[0,100],"; }\n",],undefined,{path:"./components/j-alert/j-alert.wxss"});    
